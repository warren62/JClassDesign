...
public abstract class AppTemplate extends Application {
	...
	URL stylesheetURL = getClass().getResource(stylesheet);
        ...
        //System.out.println(p + "/" + stylesheet);
//        URL stylesheetURL = getClass().getResource(p + stylesheet);
//        System.out.println(stylesheetURL.toString());
//        System.out.println(stylesheetURL.toExternalForm());
	String stylesheetPath = stylesheetURL.toExternalForm();
//         System.out.println(stylesheetPath);
//        String stylesheetPath = "C:\\Users\\Steve\\Desktop\\shit\\prog\\Netbizzeans\\Final_project_cse_219\\JClassDesign\\src\\jc\\css\\jc_style.css".replace("\\", "/");

//        String stylesheetPath = p;
